      ...
      <Card className="p-8">
        <div className="prose prose-slate max-w-none">
          <div className="text-sm text-gray-500 mb-6">
            Last updated on 17-01-2025 00:15:07
          </div>

          <div className="space-y-6">
            <p className="text-gray-700">
              These Terms and Conditions, along with privacy policy or other terms ("Terms") constitute a binding
              agreement by and between RAUSHAN KUMAR, ("Website Owner" or "we" or "us" or "our") and you
            ...
            <div className="space-y-4">
              ...
              <h2 className="text-xl font-semibold mt-8 mb-4">Transactions & Refunds</h2>
              <div className="space-y-4">
                <p className="text-gray-700">
              ...
              <h2 className="text-xl font-semibold mt-8 mb-4">Force Majeure</h2>
              <p className="text-gray-700">
              ...
              <h2 className="text-xl font-semibold mt-8 mb-4">Governing Law & Jurisdiction</h2>
              <div className="space-y-4">
                <p className="text-gray-700">
                ...
                <p className="text-gray-700">
                  ...
                  jurisdiction of the courts in Chapra, Bihar.
                </p>
              </div>
